...
class Team(Base):
    ...
    submissions = relationship('Submission',
                               back_populates='team')  # Adjusted to plural to reflect potentially multiple submissions per team.
...
class Challenge(Base):
    ...
    submissions = relationship('Submission',
                               back_populates='challenges')  # Adjusted to plural since multiple submissions could be related to one challenge.
